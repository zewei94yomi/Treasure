...
function defaultSave() {
  return {
    ...
    pouches: 0,                // 腰包数量
    mercTrials: { guard: 2, vet: 2, ace: 2, sniper: 1, priest: 1, dog: 1, archer: 1, mage: 1, mech: 1, marine: 1, flamerguy: 1 },   // 雇佣兵免费试玩次数
  ...
  try {
    ...
    if (raw) {
      ...
      if (s && s.version === 1) {
        ...
        SAVE.mercTrials = Object.assign({ guard: 2, vet: 2, ace: 2, sniper: 1, priest: 1, dog: 1, archer: 1, mage: 1, mech: 1, marine: 1, flamerguy: 1 }, s.mercTrials || {});
